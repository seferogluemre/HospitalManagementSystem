...
import { postCreateDto, postDestroyDto, postIndexDto, postShowDto, postUpdateDto } from './dtos';
  ...
  .post(
    ...
    dtoWithMiddlewares(
      ...
      withAuditLog({
        ...
        getEntityUuid: (ctx) => {
          const response = ctx.response as ReturnType<typeof PostFormatter.response>;
